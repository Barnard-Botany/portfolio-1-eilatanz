...
```{r}
# Map the range of sweetgrass
map('world', fill=T, col="white", bg="light blue", xlim=c(-180,20),ylim=c(-60,80))
plot(sweetgrass_rangemap, col="blue", add=T)
```
